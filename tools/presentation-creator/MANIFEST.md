...
- [convert.py](file:///d:/Github/REVA-learning-hub/tools/presentation-creator/convert.py): Main Python script that reads the markdown input and compiles it to single-page HTML slides.
- [template-default.html](file:///d:/Github/REVA-learning-hub/tools/presentation-creator/template-default.html): Baseline/reference HTML file displaying the intended premium aesthetic, styling, navigation, and interactive quiz component behaviors.
- [requirements.txt](file:///d:/Github/REVA-learning-hub/tools/presentation-creator/requirements.txt): List of Python libraries required for conversion.
